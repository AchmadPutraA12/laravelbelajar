                    ...
                    <tr>
                        ...
                        <td>
                            <div class="text-center">
                                <a href="{{ url('admin/kategori/show/' . $k->id) }}" class="btn btn-sm btn-info">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ url('admin/kategori/edit/' . $k->id) }}" class="btn btn-sm btn-warning">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="{{ url('admin/kategori/pdfshow/' . $k->id) }}" class="btn btn-sm btn-info">
                                    <i class="fas fa-file-pdf"></i>
                                </a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{ url('admin/kategori/delete/' . $k->id) }}" type="button" class="btn btn-primary">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
