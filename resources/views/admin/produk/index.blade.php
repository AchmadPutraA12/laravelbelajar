            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{url('admin/produk/show/'.$pr->id)}}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a></td>
                        <td><a href="{{url('admin/produk/edit/'.$pr->id)}}" class="btn btn-sm btn-warning"><i class="far fa-edit"></i></a></td>
                        <td>
                            <a href="{{ url('admin/produk/pdfshow/' . $pr->id) }}" class="btn btn-sm btn-info">
