            ...
            <div class="row justify-content-between">
                <div class="col-lg-5">
                    <div class="intro-excerpt">
                        <h1>Welcome to <span clsas="d-block">MarketGo</span></h1>
                        <p class="mb-4">Discover the beauty of online shopping with our collection. Quality products, affordable prices. Quickly find what you need and enjoy a simple and enjoyable shopping experience.</p>
                        <p><a href="{{url('cart')}}" class="btn btn-secondary me-2">Shop Now</a><a href="{{url('shop')}}"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
                    <h2 class="mb-4 section-title">Choose the Product you like.</h2>
                    <p class="mb-4">Please explore our product collection. </p>
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-5 ps-lg-5">
                    ...
                    <p><a herf="#" class="btn" style="color: #ffff;">Explore</a></p>
                </div>
            </div>
        </div>
    </div>
