...
class DashboardController extends Controller
{
    ...
    public function index() {
        ...
        return view('admin.dashboard' , compact('produk', 'kategori', 'pesanan', 'pelanggan', 'pesanan_items', 'pembayaran', 'hitung_harga', 'status')); //mengarahkan ke file dashboard yang ada di dalam folder admin
    }
}
